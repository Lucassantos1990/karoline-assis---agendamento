...
export const INITIAL_APPOINTMENTS: Appointment[] = [
    {
        ...
        date: new Date(new Date().setDate(new Date().getDate() + 1) && new Date().setHours(10, 0, 0, 0)),
    ...
    },
    {
        ...
        date: new Date(new Date().setDate(new Date().getDate() + 1) && new Date().setHours(14, 0, 0, 0)),
